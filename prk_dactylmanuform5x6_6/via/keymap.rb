...
kbd.add_layer :default, %i[
  ...
  KC_LSFT   KC_I      KC_R      KC_S      KC_T      KC_G            KC_P      KC_N      KC_E      KC_A      KC_O      KC_SCOLON  
  KC_LCTL   KC_Q      KC_V      KC_W      KC_D      KC_J            KC_B      KC_H      KC_SLASH  KC_DOT    KC_X      KC_LALT  
  KC_7      KC_8      KC_SPACE  KC_LSFT   KC_NO     KC_NO           KC_NO     SPC_LAYER1     KC_BSPACE KC_ENTER  KC_8      KC_7  
...
kbd.add_layer :irstk, %i[
  ...
  KC_LSFT   KC_I      KC_R      KC_S      KC_T      KC_G            KC_P      KC_N      KC_E      KC_A      KC_O      KC_SCOLON  
  KC_LCTL   KC_Q      KC_V      KC_W      KC_D      KC_J            KC_B      KC_H      KC_SLASH  KC_DOT    KC_X      KC_LALT  
  KC_7      KC_8      KC_SPACE  KC_LSFT   KC_NO     KC_NO           SPC_LAYER1     SPC_LAYER2     KC_BSPACE KC_ENTER  KC_8      KC_7  
  KC_NO     KC_NO     KC_NO     KC_NO     KC_NO     KC_NO           KC_NO     KC_NO     KC_NO     KC_NO     KC_NO     KC_NO 
]
#Layer 1
...
kbd.define_mode_key :SPC_LAYER1, [ Proc.new { kbd.default_layer = :gaming}, nil, 200, nil ]
kbd.define_mode_key :SPC_LAYER2, [ Proc.new { kbd.default_layer = :qwerty}, nil, 300, nil ]
